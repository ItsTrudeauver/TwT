...
class AmberSunSkill(BattleSkill):
    ...
    async def on_battle_start(self, ctx: BattleContext):
        # Logic 2: If this unit IS Agott, or if Agott exists elsewhere, Agott gains power too.
        # However, per current description: "If Agott is present, both units gain 15% power."
        # This implementation handles the *owner* of the skill getting the buff.
        # To handle Agott getting the buff (if Agott doesn't have the skill), we inject it here.
